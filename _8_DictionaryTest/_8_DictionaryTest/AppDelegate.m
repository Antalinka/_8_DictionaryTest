...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    NSDictionary* dictionary = [[NSDictionary alloc]initWithObjectsAndKeys:@"Petrov", @"lastName",
                                @"Vasiliy",@"name",
...
//    NSDictionary* dictionary2 = [NSDictionary dictionaryWithObjectsAndKeys:<#(id), ...#>, nil]
    ...
    NSLog(@"%@, \n count = %lu", dictionary3, (unsigned long)[dictionary count]);
    
    
    
    NSLog(@"last name = %@, name = %@, age = %ld",
          [dictionary objectForKey:@"lastName"],
          [dictionary objectForKey:@"name"],
          (long)[[dictionary objectForKey:@"age"]integerValue]);
